...
"""
edited:
added output_dir check
added stranded='true' by default
"""
...
parser.add_argument('--is_stranded', type=str.lower, choices=['true', 'false'], default='true', help='Stranded protocol') # edited
...
if not os.path.exists(args.output_dir):	# edited
